<#
.SYNOPSIS
    Get Azure Service Principal credentials from an encrypted XML file.
.DESCRIPTION
    Get Azure Service Principal credentials from an encrypted XML file, using REST API calls.
.EXAMPLE
    Get-AzSPCredentials 
.CONTEXT
    Azure
...
.NOTES
    ...
    Purpose:        Script to decrypt the stored credentials, used by the WVD Scripts.
...
{
    # Translating Azure stored credentials information from the retrieved Credentials
    Write-Host "Azure SP tenant ID: " -NoNewline -ForegroundColor Yellow
    Write-Host $azSPCredentials.tenantID -ForegroundColor Green
    Write-Host "Azure SP app ID: " -NoNewline -ForegroundColor Yellow
    Write-Host $azSPCredentials.spCreds.UserName -ForegroundColor Green
    Write-Host "Azure SP app Secret: " -NoNewline -ForegroundColor Yellow
    Write-Host $azSPCredentials.spCreds.GetNetworkCredential().Password -ForegroundColor Green
}
else 
{
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUMJDJOigCQWwNd7VxjCSqhf+p
# /HugggpeMIIFJjCCBA6gAwIBAgIQCyXBE0rAWScxh3bGfykLTjANBgkqhkiG9w0B
...
# AQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBRRQ4MXXVVg
# N0ZuW18/yyoEHGS7ujANBgkqhkiG9w0BAQEFAASCAQCdRfyj7dQfUnie7dHWTboN
# Kb1JsA9/ERPyWjqilMYy4vOOaUCKAe1/pCmjRw5ER4eDXVBXUfnwxMa6tL1/Ba3V
# e9vWMfU5UIzyn0CT/ELYt2KIsi+X7ilz3oTgM3EUZulwXQmeKG3IGZU3qnSskoDG
# LeapiYnJoprVFPuzhhYsbLZZ+W83LPf4w8Fv88mCWsH22/nQ+yykPmYF1Ih+3bBr
# GsDQlAKyy4KOCheWttc2QnJmc8s2xWMvP56DjSmor8hnd1J3mneYoR8obfaUnMt4
# w48IN4nsEo0dz5RdQDg5KFIACINhm40Me4wiTwv+q8e12qbr0Z0YbZ7CzS/ZY1zO
